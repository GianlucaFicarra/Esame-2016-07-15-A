...
public class Airport {
	...
	//aggiungo il num dei passseggeri
	private int cntPasseggeri;
	...
	public void addPasseggero() {
		cntPasseggeri++;
	}
	
	public int getNumPasseggeri() {
		return this.cntPasseggeri;
	}
	
	public void setNumPasseggeri() {
		this.cntPasseggeri=0;
	}
